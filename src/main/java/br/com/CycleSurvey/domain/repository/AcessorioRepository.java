...
public class AcessorioRepository implements Repository<Acessorio, Long> {
    ...
    public Acessorio findById(Long id) {
        ...
        var sql = "SELECT *  FROM TB_ACESSORIO  where ID_ACESSORIO = ?";
        Connection con = factory.getConnection();
    ...
    public Acessorio persiste(Acessorio ac) {
        ...
        var sql = "INSERT INTO tb_acessorio (id_acessorio, marca_acessorio , modelo, tipo_acessorio, valor,nota_fiscal_acessorio, id_bike) VALUES (SEQ_ACESSORIO.nextval, ?,?,?,?,?,?)";
        ...
        try {
            ...
            ps = con.prepareStatement( sql, new String[]{"ID_ACESSORIO"} );
